    ...
    for record in result:
        try:
            ...
            if(thegamesdbid != 'None'):
                rowdata = "<tr align='center'><td><a href='removegame?dbid=" + db_id + "'><img src='images/icon.delete.png'/></a>&nbsp;<a href='forcesearch?dbid=" + db_id + "'><img src='images/icon.search.png'/></a>&nbsp;<a href='forcepost'><img src='images/icon.folder.gif'/></a></td><td><center><img width='85' height='120'  src='" + cover + "' /></center></td><td><a href='http://thegamesdb.net/game/" + thegamesdbid + "' target='_blank' >" + game_name + "</td><td>" + game_type + "</td><td>" + system + "</td><td>" + status + "</td><td><select id=updateSatusSelectObject class=ui-widget onchange=UpdateGameStatus(this.options[this.selectedIndex].value,'" + db_id + "')>"
            else:
                rowdata = "<tr align='center'><td><a href='removegame?dbid=" + db_id + "'><img src='images/icon.delete.png'/></a>&nbsp;<a href='forcesearch?dbid=" + db_id + "'><img src='images/icon.search.png'/></a>&nbsp;<a href='forcepost'><img src='images/icon.folder.gif'/></a></td><td><center><img width='85' height='120'  src='" + cover + "' /></center></td><td>" + game_name + "</a></td><td>" + game_type + "</td><td>" + system + "</td><td>" + status + "</td><td><select id=updateSatusSelectObject class=ui-widget onchange=UpdateGameStatus(this.options[this.selectedIndex].value,'" + db_id + "')>"
            if(status == "Snatched"):
